  ...
  app.post('/resources', function (req, res) {
    fs.readFile('./data.json', 'utf8', (err, data) => {
      ...
      const filterObject = {
        ...
        ...req.body.acceptable_cities && { acceptable_cities: req.body.acceptable_cities },
        ...req.body.unacceptable_cities && { unacceptable_cities: req.body.unacceptable_cities },
        ...
        ...req.body.estimated_population && { estimated_population: req.body.estimated_population },
        ...req.body.latitude && { latitude: req.body.latitude },
        ...req.body.longitude && { longitude: req.body.longitude }
      };
      var filteredData = null;
      if (filterObject.latitude && filterObject.longitude)
        filteredData = filterHelper.closestLocation(filterObject, allData);
      else
        var filteredData = filterHelper.propertyFilter(filterObject, allData);
